...
uv run --project CODEALONGS python \
  CODEALONGS/m0_python_foundations/02_packages_and_model_access/02_huggingface_offline.py
uv run --project CODEALONGS python \
  CODEALONGS/m0_python_foundations/02_packages_and_model_access/03_gemini_api.py
uv run --project CODEALONGS jupyter lab CODEALONGS/m0_python_foundations/02_packages_and_model_access
```
