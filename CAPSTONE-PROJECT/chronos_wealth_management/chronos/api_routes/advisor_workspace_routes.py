...
def ask_advisor_assistant(
    ...
    # M8 remains an optional lab seam; production owns the M9 persistence
    # and approval workflow below.
    ...
    with translate_domain_errors():
        ...
        draft = submit_note_for_approval(
            db, advisor_user_id, client_user_id, request.question, answer,
