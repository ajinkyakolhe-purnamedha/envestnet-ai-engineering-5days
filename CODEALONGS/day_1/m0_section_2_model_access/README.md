...
uv run --project CODEALONGS python \
  CODEALONGS/day_1/m0_section_2_model_access/02_huggingface_offline.py
uv run --project CODEALONGS python \
  CODEALONGS/day_1/m0_section_2_model_access/03_gemini_api.py
uv run --project CODEALONGS jupyter lab CODEALONGS/day_1/m0_section_2_model_access
```
