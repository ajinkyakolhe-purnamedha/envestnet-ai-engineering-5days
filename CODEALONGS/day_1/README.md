...
Day 1 is organized as one top-level folder per module:

```text
day_1/
├── m0_python_foundations/
├── m1_model_access/
├── m2_model_tokens_context/
...
Run commands from the `CODEALONGS/` project root unless a module README says to
